...
**State:** v63, working and in daily use; see `STATUS.md`.
...
| `DECISIONS.md` | **D1–D89** — every design ruling and the measurement behind it |
...
DECISIONS.md            D1–D89 — every design ruling, with its measurement
...
They are **not** in this file. `DECISIONS.md` holds all 89, with the measurements intact —
